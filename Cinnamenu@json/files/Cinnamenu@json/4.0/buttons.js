...
/** huntantr */
class UserContextMenuItem extends PopupBaseMenuItem {
  ...
  activate(event) {
    ...
    switch (this.action) {
      ...
      case 'switch_user':
        ...
        spawnCommandLine('dm-tool switch-to-greeter');
        this.state.trigger('closeMenu');
        break;
      case 'logout':
        spawnCommandLine('cinnamon-session-quit --logout');
        this.state.trigger('closeMenu');
        break;
    }
    return false;
...
class UserButton extends PopupBaseMenuItem {
...
module.exports = {CategoryListButton, AppListGridButton, GroupButton, UserButton};
